...
$sql="SELECT * FROM take_attendance  WHERE subject='AME - Mr.Mirza' ORDER BY id DESC ";
$res=mysqli_query($db,$sql);
$num=mysqli_num_rows($res);
$sql1="SELECT * FROM take_attendance  WHERE subject='AME - Mr.Mirza' ORDER BY id DESC ";
 ...
 <nav class="navbar-nav fixed-top" style="background-color: black;padding-top: 10px;">
     ...
     <div class="col-sm-4">
       <div style="text-align: center;">
         <p style="font-size: 30px;color: white;">AME Attendance</p>
       </div>
     </div>
     <div class="col-sm-4">
